...
def broadcast_weights(model, engine, model_update_group):
    """
    NOTE: `model` likely needs to be unwrapped

    One process should do this which should be the one assigned in `create_vllm_engines`
    """
